...
CAMERA_URL = "http://10.208.18.222/"

# 2. The Hands: Where the LCD, LEDs, and Buzzer are (Update this!)
CONTROLLER_URL = "http://10.208.18.239/"

NAMES = ['Unknown','Joseph','Alan','George','George','Milan'] 
...
@app.route('/')
def index():
    # 1. "Eat" any leftover button presses stuck in the ESP32's memory
    try:
        requests.get(f"{CONTROLLER_URL}button", timeout=1)
    except:
        pass
        
    # 2. Now that the memory is clean, load the sleeping page
